package com.skt.thingplug_v2_0_service.data;
...
public enum SensorType {
    // type                     category                    nickname            name                                                        image                               value type          tlv types                       tdv types                       decimal place           value infos {name, measure}
    BATTERY                    (Category.BROADCAST,         "Battery",          new String[]{"batteryTemperature", "batteryGuage"},                                    R.mipmap.icon_batterygauge_big,     ValueType.NUMBER,   new int[]{0x04, 0x05},          new int[]{0x04, 0x05},          new int[]{2, 0},        new String[][]{{"Temperature", "℃"}, {"Charge", "％"}}), // A constant describing a current battery status. {temperature, chargeLevel}

    AMBIENT_TEMPERATURE        (Category.SENSOR_MANAGER,    "Temperature",      new String[]{"temperature"},                                R.mipmap.icon_temperature_big,      ValueType.NUMBER,   new int[]{0x11},                new int[]{0x11},                new int[]{2},           new String[][]{{"Ambient temperature", "℃"}}), // This constant was deprecated in API level 14. use Sensor.TYPE_AMBIENT_TEMPERATURE instead.
    RELATIVE_HUMIDITY          (Category.SENSOR_MANAGER,    "Humidity",         new String[]{"humidity"},                                   R.mipmap.icon_humidity_big,         ValueType.NUMBER,   new int[]{0x12},                new int[]{0x12},                new int[]{2},           new String[][]{{"Air humidity", "%"}}), // A constant describing a relative humidity sensor type.
    NOISE                      (Category.MEDIA_RECORDER,    "Noise",            new String[]{"noise"},                                      R.mipmap.icon_noise_big,            ValueType.NUMBER,   new int[]{0x13},                new int[]{0x13},                new int[]{2},           new String[][]{{"Noise", "㏈"}}),

    GPS                        (Category.LOCATION_MANAGER,  "GPS",              new String[]{"latitude", "longitude", "altitude"},          R.mipmap.icon_actuator_big,         ValueType.NUMBER,   new int[]{0x20, 0x21, 0x22},    new int[]{0x20, 0x21, 0x22},    new int[]{5, 5, 0},     new String[][]{{"Latitude", "˚"}, {"Longitude","˚"}, {"Altitude","˚"}}),    // A constant describing a GPS sensor status. {latitude, longitude, altitude}
    PRESSURE                   (Category.SENSOR_MANAGER,    "Air Pressure",     new String[]{"airPressure"},                                R.mipmap.icon_pressure_big,         ValueType.NUMBER,   new int[]{0x24},                new int[]{0x24},                new int[]{1},           new String[][]{{"Pressure", "h㎩"}}),                                       // A constant describing a pressure sensor type.
    LIGHT                      (Category.SENSOR_MANAGER,    "Light",            new String[]{"light"},                                      R.mipmap.icon_light_big,            ValueType.NUMBER,   new int[]{0x25},                new int[]{0x25},                new int[]{0},           new String[][]{{"Level", "㏓"}}),                                           // A constant describing a light sensor type.
    BUZZER                     (Category.ACTUATOR,          "Buzzer",           new String[]{"buzzer"},                                     R.mipmap.icon_buzzer_big,           ValueType.NUMBER,   new int[]{0x87},                new int[]{0x87},                new int[]{0},           new String[][]{{"", ""}}),
    LED                        (Category.ACTUATOR,          "Led",              new String[]{"led"},                                        R.mipmap.icon_color_big,            ValueType.NUMBER,   new int[]{0x88},                new int[]{0x88},                new int[]{0},           new String[][]{{"", ""}}),

    PROXIMITY                  (Category.SENSOR_MANAGER,    "Proximity",        new String[]{"distance"},                                   R.mipmap.icon_peoplecount_big,      ValueType.NUMBER,   new int[]{0x31},                new int[]{0x31},                new int[]{0},           new String[][]{{"Distance", "㎝"}}), // A constant describing a proximity sensor type.
    CAMERA                     (Category.ACTUATOR,          "Camera",           new String[]{"camera"},                                     R.mipmap.icon_camera_big,           ValueType.NUMBER,   new int[]{0x84},                new int[]{0x84},                new int[]{0},           new String[][]{{"", ""}}),

    ACCELEROMETER              (Category.SENSOR_MANAGER,    "Accelerometer",    new String[]{"accel_x", "accel_y", "accel_z"},              R.mipmap.icon_accelerometer_big,    ValueType.NUMBER,   new int[]{0x41, 0x42, 0x43},    new int[]{0x41, 0x42, 0x43},    new int[]{2, 2, 2},     new String[][]{{"X", "㎨"}, {"Y", "㎨"}, {"Z", "㎨"}}), // A constant describing an accelerometer sensor type.

    ORIENTATION                (Category.SENSOR_MANAGER,    "Orientation",      new String[]{"azi", "pitch", "roll"},                       R.mipmap.icon_windvane_big,         ValueType.NUMBER,   new int[]{0x44, 0x45, 0x46},    new int[]{0x44, 0x45, 0x46},    new int[]{0, 0, 0},     new String[][]{{"Azimuth", "˚"}, {"Pitch", "˚"}, {"Roll", "˚"}}), // This constant was deprecated in API level 8. use SensorManager.getOrientation() instead.
    GRAVITY                    (Category.SENSOR_MANAGER,    "Gravity",          new String[]{"grav_x", "grav_y", "grav_z"},                 R.mipmap.icon_weight_big,           ValueType.NUMBER,   new int[]{0x47, 0x48, 0x49},    new int[]{0x47, 0x48, 0x49},    new int[]{2, 2, 2},     new String[][]{{"X", "㎨"}, {"Y", "㎨"}, {"Z", "㎨"}}), // A constant describing a gravity sensor type.
    GYROSCOPE                  (Category.SENSOR_MANAGER,    "Gyroscope",        new String[]{"gyro_x", "gyro_y", "gyro_z"},                 R.mipmap.icon_rotaryangle_big,      ValueType.NUMBER,   new int[]{0x4A, 0x4B, 0x4C},    new int[]{0x4A, 0x4B, 0x4C},    new int[]{2, 2, 2},     new String[][]{{"X", "˚"}, {"Y", "˚"}, {"Z", "˚"}}), // A constant describing a gyroscope sensor type.
    MAGNETIC_FIELD             (Category.SENSOR_MANAGER,    "Magnetic Field",   new String[]{"magn_x", "magn_y", "magn_z"},                 R.mipmap.icon_vibration_big,        ValueType.NUMBER,   new int[]{0x4D, 0x4E, 0x4F},    new int[]{0x4D, 0x4E, 0x4F},    new int[]{2, 2, 2},     new String[][]{{"X", "µT"}, {"Y", "µT"}, {"Z", "µT"}}), // A constant describing a magnetic field sensor type.
    STEP_DETECTOR              (Category.SENSOR_MANAGER,    "Step Detector",    new String[]{"stepDetection"},                              R.mipmap.icon_motion_on_big,      ValueType.NUMBER,   new int[]{0x3D},                new int[]{0x32},                new int[]{0},           new String[][]{{"Detection", ""}}), // A constant describing a step detector sensor.
    STEP_COUNTER               (Category.SENSOR_MANAGER,    "Step Count",       new String[]{"stepCount"},                                  R.mipmap.icon_motion_on_big,        ValueType.NUMBER,   new int[]{0x3E},                new int[]{0x33},                new int[]{0},           new String[][]{{"Count", "steps"}}), // A constant describing a step counter sensor.
...
//    STATIONARY_DETECT          (Category.SENSOR_MANAGER,    "STATIONARY_DETECT",            R.mipmap.ic_launcher,               ValueType.NUMBER,   new int[]{0x00},                new int[]{0x00},                new int[]{0},           new String[][]{{"", ""}}),                                                  // A constant describing a stationary detect sensor.
    DEVICE                     (Category.ACTUATOR,          "Device",           new String[]{},                                             -1,                                 ValueType.NUMBER,   new int[]{0x9F},                new int[]{0x9F},                new int[]{0},           null),
    NONE                       (Category.SENSOR_MANAGER,    "NONE",             new String[]{},                                             -1,                                 ValueType.NUMBER,   null,                           null,                           null,                   null);                                                                      // none
    ...
    private String[]    name;               // sensor tag(Simple)
     ...
     */
    SensorType(Category category, String nickname, String[] name, int image, ValueType valueType, int[] tlvTypes, int[] tdvTypes, int[] valueDecimalPlaces, String[][] valueInfos) {
