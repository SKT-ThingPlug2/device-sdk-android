package com.skt.thingplug_v2_0_service;
...
public class Const {
    // ThingPlug URLs
    private static final int GET_LENGTH_MAX = 50;
    ...
    // control check delay
    public static final int SENSOR_CONTROL_CHECK_DELAY = 10000;
    public static final int SENSOR_ACTIVATE_CHECK_DELAY = 3000;
